package com.fabianosdev.astrofoto.Adapters;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewholderPhotos>
    ...
    @NonNull
    @Override
    public ViewholderPhotos onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ViewholderPhotos holder, int position) {
