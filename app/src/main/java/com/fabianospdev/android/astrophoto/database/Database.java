...
public class Database extends SQLiteOpenHelper {
  ...
  private static final String[] Photocol = {CODE_COLUMN, NAME_COLUMN, CAMERA_COLUMN, LENS_COLUMN,
      SCHEDULE_COLUMN,  EXPOSE_COLUMN,  ISO_SENSITIVITY_COLUMN,  DIAPHRAGM_OPENING_COLUMN,  FOCAL_DISTANCE_COLUMN,
      DPI_RESOLUTION_COLUMN,  FLASH_MODE_COLUMN, WHITE_BALANCE_COLUMN, ROTATION_COLUMN, TAGS_COLUMN,
      WIDTH_COLUMN, HEIGHT_COLUMN,  SIZE_COLUMN,  PATH_COLUMN,  GEOLOCATION_COLUMN,  IMAGE_COLUMN,};
  ...
  public List<Photo> listAllPhotos() {
    ...
    if(c.moveToFirst()) {
      do {
        ...
        photo.setLens( c.getString( 3 ) );
        photo.setSchedule( c.getString( 4 ) );
        photo.setExpose( c.getString( 5 ) );
        photo.setIso_sensitivity( c.getString( 6 ) );
        photo.setDiaphragm_opening( c.getString( 7 ) );
        photo.setFocal_distance( c.getString( 8 ) );
        photo.setDpi_resolution( c.getString( 9 ) );
        photo.setFlash_mode( c.getString( 10 ) );
        photo.setWhite_balance( c.getString( 11 ) );
        photo.setRotation( c.getString( 12) );
        photo.setTags( c.getString( 13 ) );
        photo.setWidth( c.getString( 14 ) );
        photo.setHeight( c.getString( 15 ) );
        photo.setSize( c.getString( 16 ) );
        photo.setPath( c.getString( 17 ) );
        photo.setGeolocation( c.getString( 18 ) );
        photo.setImage(c.getBlob( 19 ) );
